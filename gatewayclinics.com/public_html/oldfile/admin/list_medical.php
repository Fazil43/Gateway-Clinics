...
$decodednewsid=base64_decode($gettingproductnameid);
 ...
 $sel="SELECT  * FROM  $_table62 where id='$decodednewsid' ";
...
$set_limit     = $page * $limit - ($limit);
 $sel="SELECT * FROM $_table62 ORDER BY id DESC LIMIT $set_limit, $limit  ";
		$result=mysql_query($sel,$link) or die (mysql_error());
...
?>
		    <tr class="<?php echo $tablecss?>">
		      ...
		      <td width="106" align="center" valign="top" class="table_slicer"><a href="delete_medical.php?nid=<?php echo $encoded_cid?>" onclick="return confirm('Are you sure you want to delete?')"  title="Delete">Delete</a></td>
	        </tr>
		    <?php }?>
	      </table>
