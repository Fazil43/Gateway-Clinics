...
$decodedcategoryid=base64_decode($gettingitemid);
 ...
 $sel="SELECT  * FROM  $_table25 where id='$decodedcategoryid' ";
...
?>
		<form action="comcategory_add.php?action=<?php echo $do?>" method="post"  enctype="multipart/form-data" name="news" id="news"  onsubmit="return inamodel_validate(this);" onreset="resetform()">
...
?>
		          <tr class="<?php echo $tablecss?>"onmouseover="this.bgColor='#B6DAF8'" onmouseout="this.bgColor='#FFFFFF'">
		            ...
		            <td width="73" align="center" valign="middle"><a href="comcategory_add.php?cid=<?php echo $encoded_cid?>"><img src="images/
					images/Modify.png" width="20" height="20" border="0" title="Edit category" /></a></td>
		            <td width="80" align="center" valign="middle" class="table_slicer"><a href="delete_comcategory.php?nid=<?php echo $encoded_cid?>" onclick="return confirm('Are you sure you want to delete?')"  title="Delete"><img src="images/Delete.png" width="20" height="20" border="0" /></a></td>
	              </tr>
		          <?php }?>
              </table></td>
	        </tr>
...
$category=addslashes($category1);
 ...
 $insert="insert into $_table25 (category) values('$category')";
$step1result=mysql_query($insert,$link) or die(mysql_error());
$message=base64_encode('category_success');
header("location:comcategory_add.php?mes=$message&$random");
...
$newsid=$_POST['updated_id'];
  ...
  $update="update $_table25 set category='$category' where  id='$newsid' ";
