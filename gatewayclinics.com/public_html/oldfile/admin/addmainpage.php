...
<body>
	...
	<div id="content" class="shell">
	  ...
	  <div id="help-nav"></div>
		...
		<form action="addmainpage.php?action=<?php echo $do;?>"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
...
<?php echo $details;?></textarea></td>
		        ...
		        <tr>
		          <td width="129" valign="top" class="left">Upload Logo</td>
...
$createddate=date('Y-m-d');
 ...
 $insert="insert into $_table54(username,title,details,image,createddate)values('$username','$title','$details','$resized','$serverdate')";
...
header("location:addmainpage.php?mes=$message&$random");
