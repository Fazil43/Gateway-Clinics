...
$decodednewsid=base64_decode($gettingproductnameid);
 ...
 $sel="SELECT  * FROM  $_table58 where id='$decodednewsid' ";
...
<?php echo $_SESSION['SESS_USER_NAME'];?>
		<h6 class="red">Welcome <br />
	  </h6>
		<form action="update_newsgallery.php?action=<?php echo $do;?>"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
		    ...
		    <tr>
		      <td width="817" align="center"><table width="800" border="0" align="center">
		        ...
		        <tr>
		          ...
		          <td><input type="file" name="image" accept="image/gif,image/png,image/jpg,image/jpeg" id="image" />
	              <span class="red"></span><img src="<?php echo $root;?>/admin/<?php echo $image;?>" /></td>
	            </tr>
		        <tr>
		        ...
		        <tr>
		          <td colspan="2">&nbsp;</td>
		          <td><input name="step1" type="submit" id="step1" value="<?php echo $do;?>" /></td>
	            </tr>
		        <tr>
		          <td colspan="2">&nbsp;</td>
		          <td>&nbsp;</td>
...
$extension = getExtension($filename); 		$extension = strtolower($extension);
 if (($extension != "jpeg") && ($extension != "jpg") && ($extension != "pdf") && ($extension != "png")&& ($extension != "gif"))  		{
...
$Upinsql="update $_table58 set image='$image_name' where id='$newsid'";
...
header("location:list_gallery.php?srid=$encoded_id");
