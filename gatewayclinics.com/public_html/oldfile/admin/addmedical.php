...
<body>
	...
	<div id="content" class="shell">
	  ...
	  <div id="help-nav"></div>
		...
		<form action="addmedical.php?action=<?php echo $do;?>"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
...
$createddate=date('Y-m-d');
 ...
 $insert="insert into $_table62 (image)values('$resized')";
...
header("location:addmedical.php?mes=$message&$random");
