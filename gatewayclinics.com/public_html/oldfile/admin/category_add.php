...
?>
		<form action="category_add.php?action=<?php echo $do?>" method="post"  enctype="multipart/form-data" name="news" id="news"  onsubmit="return inamodel_validate(this);" onreset="resetform()">
		  <table width="1000" border="1" bordercolor="#000000" align="center" cellpadding="1" cellspacing="1">
		    <tr>
		      <td width="817" align="center"><table width="800" border="0" align="center">
		        ...
		        <tr>
		          <td  valign="top" class="left">Verification Code* </td>
...
?>
		          <tr class="<?php echo $tablecss?>"onmouseover="this.bgColor='#B6DAF8'" onmouseout="this.bgColor='#FFFFFF'">
		            ...
		            <td width="73" align="center" valign="middle"><a href="updatecategory_add.php?cid=<?php echo $encoded_cid?>"><img src="images/
					Modify.png" width="20" height="20" border="0" title="Edit category" /></a></td>
		            <td width="80" align="center" valign="middle" class="table_slicer"><a href="delete_category.php?nid=<?php echo $encoded_cid?>" onclick="return confirm('Are you sure you want to delete?')"  title="Delete"><img src="images/Delete.png" width="20" height="20" border="0" /></a></td>
	              </tr>
		          <?php }?>
              </table></td>
	        </tr>
...
if(md5($verif_box).'a4xn' == $_COOKIE['tntcon']){
	...
	header("Location: category_add.php?category=$category"."&wrong_code=true");
	exit;
}
 $insert="insert into $_table2 (category,filename) values('$category','$image_name2')";
$step1result=mysql_query($insert,$link) or die(mysql_error());
$message=base64_encode('category_success');
header("location:category_add.php?mes=$message&$random");
