...
$sql="select * from $_table24  where id='$categoryid'";
...
?>
		    <tr class="<?php echo $tablecss?>">
		      ...
		      <td align="left" valign="top" class="table_slicer"><textarea id="textarea1" name="details" style="height: 170px; width: 500px;">

<?php echo $displaydescription;?></textarea> </td>
		      <td width="96" align="center" valign="top"><a href="addaboutus.php?nid=<?php echo $encoded_cid?>">Edit</a></td>
		      <td width="106" align="center" valign="top" class="table_slicer"><a href="delete_aboutus.php?nid=<?php echo $encoded_cid?>" onclick="return confirm('Are you sure you want to delete?')"  title="Delete">Delete</a></td>
	        </tr>
		    <?php }?>
	      </table>
