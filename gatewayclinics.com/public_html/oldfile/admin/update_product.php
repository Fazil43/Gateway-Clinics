...
<body>
	...
	<div id="content" class="shell">
		...
		<form action="update_product.php?action=<?php echo $do;?>"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
...
$Upinsql="update $_table4 set category='$category',details='$details' where id='$newsid'";
