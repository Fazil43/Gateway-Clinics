...
<body>
	...
	<div id="content" class="shell">
	  ...
	  <div id="help-nav"></div>
		...
		<form action="adddoctordet.php"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
...
if(md5($verif_box).'a4xn' == $_COOKIE['tntcon']){
	...
	header("Location: adddoctordet.php?category=$category&$image=$image"."&wrong_code=true");
	exit;
}
				$createdon=$serverdate;	
 $insert="insert into $_table48 (username,category,image,details,createddate)values('$username','$category','$resized','$details','$serverdate')";
...
header("location:adddoctordet.php?mes=$message&$random");
