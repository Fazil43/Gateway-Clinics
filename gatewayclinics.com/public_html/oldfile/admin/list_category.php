...
$set_limit     = $page * $limit - ($limit);
 $sel="SELECT * FROM $_table2  ORDER BY id DESC LIMIT $set_limit, $limit  ";
		$result=mysql_query($sel,$link) or die (mysql_error());
...
?>
		    <tr class="<?php echo $tablecss?>">
		      ...
		      <td align="left" valign="top" class="table_slicer"><img src="<?php echo $root;?>/uploads2/<?php echo $filename;?>" width="150" height="150" border="0" /></td>
		      <td width="96" align="center" valign="top"><a href="update_category.php?nid=<?php echo $encoded_cid?>">Edit</a></td>
		      <td width="106" align="center" valign="top" class="table_slicer"><a href="delete_category.php?nid=<?php echo $encoded_cid?>" onclick="return confirm('Are you sure you want to delete?')"  title="Delete">Delete</a></td>
	        </tr>
		    <?php }?>
	      </table>
