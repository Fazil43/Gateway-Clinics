...
$tbl_name="medicalbanner"; // Table name
		...
		<form id="myform" name="myform" method="post" onsubmit='return confirmChecks(this);' action="list_banner.php">
		  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="">
		    ...
		    <tr>
		      ...
		      <td align="center" valign="top" class="style2">Action</td>
	        </tr>
...
?>
		    <tr class="<?php echo $tablecss?>">
		      ...
		      <td width="106" align="center" valign="top" class="table_slicer"><a href="delete_medicalbanner.php?nid=<?php echo $encoded_cid?>" onclick="return confirm('Are you sure you want to delete?')"  title="Delete">Delete</a></td>
	        </tr>
		    <?php }?>
	      </table>
