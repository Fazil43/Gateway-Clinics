...
if(isset($_POST['delete'])){
	...
	if($sql){
		...
		header('Location:list_aboutus.php');//THIS WAS SAMPLE.PHP - YOU MIGHT WANT TO CHANGE IT BACK
...
$decodednewsid=base64_decode($gettingproductnameid);
 ...
 $sel="SELECT  * FROM  $_table63 where id='$decodednewsid' ";
		...
		<form id="myform" name="myform" method="post" onsubmit='return confirmChecks(this);' action="list_productnew.php">
		  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="">
		    ...
		    <tr>
		      ...
		      <td width="47" height="23" valign="top" class="style2">Name</td>
...
?>
		    <tr class="<?php echo $tablecss?>">
		      ...
		      <td height="20" align="left" valign="top" class="table_slicer"><?php echo $sno?></td>
              		      <td height="20" align="left" valign="top" class="table_slicer"><?php echo $category?></td>

		   
		      <td align="left" valign="top" class="table_slicer"><textarea id="details" name="details" style="height: 170px; width: 500px;">

<?php echo $details;?></textarea></td>
		      <td width="96" align="center" valign="top"><a href="update_doctordet.php?nid=<?php echo $encoded_cid?>">Edit</a></td>
		      <td width="106" align="center" valign="top" class="table_slicer"><a href="delete_doctordet.php?nid=<?php echo $encoded_cid?>" onclick="return confirm('Are you sure you want to delete?')"  title="Delete">Delete</a></td>
	        </tr>
		    <?php }?>
	      </table>
