...
unlink("thumbs/".$del_img1->image."");
	...
	if($sql){
		...
		header('Location:list_common.php');//THIS WAS SAMPLE.PHP - YOU MIGHT WANT TO CHANGE IT BACK
...
<!-- Navigation --><!-- End Navigation -->
	...
	<div id="content" class="shell">
		...
		<form id="myform" name="myform" method="post" onsubmit='return confirmChecks(this);' action="common.php">
		  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="">
		    ...
		    <tr>
			  ...
			  <td width="245" valign="top" class="style2">Details</td>
		      <td colspan="2" align="center" valign="top" class="style2">Action</td>
	        </tr>
        
		    <?php $sel="SELECT  * FROM  $_table84 ";
...
$sql="select * from $_table83  where id='$categoryid'";
$rs=mysql_query($sql,$link);
if($fetch_sr_data=mysql_fetch_array($rs))
{
$c_id=$fetch_sr_data['id'];
...
?>
		    <tr class="<?php echo $tablecss?>">
		      ...
		      <td align="left" valign="top" class="table_slicer"><?php echo $details;?></td>
		      <td width="96" align="center" valign="top"><a href="update_common.php?nid=<?php echo $encoded_cid?>">Edit</a></td>
		      <td width="106" align="center" valign="top" class="table_slicer"><a href="delete_common.php?nid=<?php echo $encoded_cid?>" onclick="return confirm('Are you sure you want to delete?')"  title="Delete">Delete</a></td>
	        </tr>
		    <?php }?>
	      </table>
