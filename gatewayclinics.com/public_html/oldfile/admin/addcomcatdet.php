...
$decodednewsid=base64_decode($gettingproductnameid);
 ...
 $sel="SELECT  * FROM  $_table83 where id='$decodednewsid' ";
...
<?php echo $details;?></textarea>
  ...
  generate_wysiwyg('textarea1');
		    ...
		    <tr>
		      <td>&nbsp;</td>
		      <td><input type="submit" name="Submit" value="<?php echo $do;?>Common" /></td>
	        </tr>
		    <tr>
		      <td>&nbsp;</td>
		      <td>&nbsp;</td>
...
$details=addslashes($details1);
 ...
 $details=$details1;
		...
		$createddate=$serverdate;
			...
			$dbase_insert = "insert into $_table83(username,category,details,createddate)values('$username','$category','$details','$serverdate')";
...
$detailsid=$_POST['updated_id'];
  ...
  $update="update $_table83 set category='$category',details='$details' where  id='$detailsid' ";
