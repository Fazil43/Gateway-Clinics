...
$delete1="select image from $_table4 where  id='$neid'";
$qry1=mysql_query($delete1,$link) or die(mysql_error());
$del_img1=mysql_fetch_object($qry1);
unlink("thumbs5/".$del_img1->image."");
$sql2="delete from $_table4  where id='$neid'";
	$result=mysql_query($sql2,$link) or die(mysql_error());
	
 

header("location:list_doctorgallery.php");
?>