...
<?php echo $_SESSION['SESS_USER_NAME'];?>
		...
		<form action="update_gallery.php?action=<?php echo $do;?>"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
...
$Upinsql="update $_table4 set image='$resized' where id='$newsid'";
