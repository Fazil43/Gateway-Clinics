...
<body>
	...
	<div id="content" class="shell">
		...
		<form action="addcommon.php?action=<?php echo $do?>" method="post"  enctype="multipart/form-data" name="news" id="news"  onsubmit="javascript:return onsubmitform()" onreset="resetform()">
...
$createdon=$serverdate;		
	...
	$dbase_insert = "insert into $_table84(category,image,filesize,details,createddate)values('$category','$image','$','$details','$serverdate')";
			$dbase_inserted = mysql_query($dbase_insert,$link);
			$id1=mysql_insert_id();
			
header("location:addcommon.php?mes=$message&$random");
