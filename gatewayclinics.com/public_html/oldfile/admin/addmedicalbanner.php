...
<body>
	...
	<div id="content" class="shell">
	  ...
	  <div id="help-nav"></div>
		...
		<form action="addmedicalbanner.php?action=<?php echo $do;?>"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
		  <table width="1000" border="1" bordercolor="#000000" align="center" cellpadding="1" cellspacing="1">
		    <tr>
		      <td width="817" align="center"><table width="800" border="0" align="center">
		        ...
		        <tr>
		          <td width="129" valign="top" class="left">Upload medical banner</td>
...
$createddate=date('Y-m-d');
 ...
 $insert="insert into $_table59 (username,image,createddate)values('$username','$resized','$serverdate')";
...
header("location:addmedicalbanner.php?mes=$message&$random");
