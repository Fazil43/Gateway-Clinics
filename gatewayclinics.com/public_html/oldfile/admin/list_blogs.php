...
$tbl_name="vijaydream"; // Table name
...
unlink("thumbs/".$del_img1->image."");
	...
	if($sql){
		...
		header('Location:list_blogs.php');//THIS WAS SAMPLE.PHP - YOU MIGHT WANT TO CHANGE IT BACK
		...
		<form id="myform" name="myform" method="post" onsubmit='return confirmChecks(this);' action="list_productnew.php">
		  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="">
		    ...
		    <tr>
		      ...
		      <td width="245" valign="top" class="style2">Category Name</td>
		      <td width="245" valign="top" class="style2">Title</td>
		      <td width="245" valign="top" class="style2">Sub Category </td>
		      <td width="245" valign="top" class="style2">Recommend page</td>
		      <td width="245" valign="top" class="style2">Video Link</td>
...
?>
		    <tr class="<?php echo $tablecss?>">
		      ...
		      <td align="left" valign="top" class="table_slicer"><?php echo $category;?></td>
		      <td align="left" valign="top" class="table_slicer"><?php echo $title;?></td>
		      <td align="left" valign="top" class="table_slicer"><?php echo $subcategory;?></td>
		      <td align="left" valign="top" class="table_slicer"><?php echo $main;?></td>
		      <td align="left" valign="top" class="table_slicer"><?php echo $video;?></td>
		      <td align="left" valign="top" class="table_slicer"><img src="http://thedesignfactory.info/beta/tdblog/admin/<?php echo $image;?>" width="150" height="150" border="0" /></td>
		      <td width="96" align="center" valign="top"><a href="update_blog.php?nid=<?php echo $encoded_cid?>">Edit</a></td>
		      <td width="106" align="center" valign="top" class="table_slicer"><a href="delete_blog.php?nid=<?php echo $encoded_cid?>" onclick="return confirm('Are you sure you want to delete?')"  title="Delete">Delete</a></td>
	        </tr>
		    <?php }?>
	      </table>
