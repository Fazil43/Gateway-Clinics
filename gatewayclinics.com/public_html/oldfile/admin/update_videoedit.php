...
<body>
	...
	<div id="content" class="shell">
		...
		<form action="update_videoedit.php?action=<?php echo $do;?>"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
...
$Upinsql="update $_table47 set name='$name',video='$video',details='$details' where id='$newsid'";
...
header("location:list_videoedit.php?mes=$message&$random");
