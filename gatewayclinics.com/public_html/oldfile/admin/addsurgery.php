...
<body>
	...
	<div id="content" class="shell">
	  ...
	  <div id="help-nav"></div>
		...
		<form action="addsurgery.php?action=<?php echo $do;?>"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
...
$createddate=date('Y-m-d');
 ...
 $insert="insert into $_table75(username,title,details,image,createddate)values('$username','$title','$details','$upload','$serverdate')";
...
header("location:addsurgery.php?mes=$message&$random");
