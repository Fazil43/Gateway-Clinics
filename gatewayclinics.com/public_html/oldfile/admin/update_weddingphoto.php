...
<body>
	...
	<div id="content" class="shell">
		...
		<form action="update_weddingphoto.php?action=<?php echo $do;?>"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
		      ...
		      <td align="center"><table width="700" border="0" align="center">
		        ...
		        <tr>
		          ...
		          <td valign="top"><label for="name2"></label>
		            <span class="inputtextfiled_names">		            </span><span class="inputtextfiled_names">
		            <label>
	                </label>
                    </span>
                    <label>
                    <span class="inputtextfiled_names">
                    <input name="category" type="text" id="category" value="<?php echo $category;?>" />
                    </span>
                    </label>
                    <span class="inputtextfiled_names"></span><span class="inputtextfiled_names">	                </span></td>
	            </tr>
		        <tr>
		          <td valign="top">&nbsp;</td>
...
$Upinsql="update $_table48 set category='$category',details='$details' where id='$newsid'";
...
header("location:list_weddingphoto.php?srid=$encoded_id");
