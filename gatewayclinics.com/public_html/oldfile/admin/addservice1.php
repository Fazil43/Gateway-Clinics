...
<table width="950" align="center" cellpadding="0"  cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td width="877"><form id="example" name="example"  onsubmit="return Inamodel_validate(this);"method="post" action="addservice1.php">
...
header("location:addservice1.php?mes=$message&nid=$encoded_id&$random");
