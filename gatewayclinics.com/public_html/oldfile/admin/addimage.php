...
<body>
	...
	<div id="content" class="shell">
		...
		<form action="addimage.php"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
...
$createddate=date('Y-m-d');
	...
	$your_image->newWidth = 800;
	$your_image->newHeight = 600;
...
if(md5($verif_box).'a4xn' == $_COOKIE['tntcon']){
	...
	header("Location: addimage.php?title=$title&$image=$image"."&wrong_code=true");
	exit;
}
...
header("location:addimage.php?mes=$message&$random");
