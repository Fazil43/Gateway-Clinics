...
$sql="select * from $_table2  where id='$categoryid'";
...
?>
		    <tr class="<?php echo $tablecss?>">
		      ...
		      <td align="left" valign="top" class="table_slicer"><?php echo $detailsdescriptions;?></td>
		      <td width="96" align="center" valign="top"><a href="addsocial.php?nid=<?php echo $encoded_cid?>">Edit</a></td>
		      <td width="106" align="center" valign="top" class="table_slicer"><a href="delete_social.php?nid=<?php echo $encoded_cid?>" onclick="return confirm('Are you sure you want to delete?')"  title="Delete">Delete</a></td>
	        </tr>
		    <?php }?>
	      </table>
