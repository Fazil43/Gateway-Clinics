...
<body>
	...
	<div id="content" class="shell">
		...
		<form action="addvideoedit.php"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
		      ...
		      <td width="817" align="center"><table width="800" border="0" align="center">
		        ...
		        <tr>
		          ...
		          <td><label class="inputtextfiled">
		            <input name="name" type="text"  class="inputtextfiled" id="name" />
		          </label></td>
	            </tr>
		        <tr>
		          <td width="129"  valign="top" class="left">Video Link</td>
		          <td width="35" align="center" valign="top">:</td>
		          <td><textarea id="vdeo" name="video" style="height: 170px; width: 500px;">

<?php echo $video;?></textarea>
		          eXAMPLE:https://www.youtube.com/watch?v=VX3Gs_VbvuQ(COPY EMBED IFRAME SOURCE CODE) </td>
	            </tr>
		        <tr>
		          <td colspan="2">&nbsp;</td>
		          <td>&nbsp;</td>
...
if(md5($verif_box).'a4xn' == $_COOKIE['tntcon']){
	...
	header("Location: addvideoedit.php?video=$video"."&wrong_code=true");
	exit;
}
				$createdon=$serverdate;	
  
 $insert="insert into $_table47(username,name,video,details,createddate)values('$username','$name','$video','$details','$serverdate')";
...
header("location:addvideoedit.php?mes=$message&$random");
