...
?>
        <form action="category_add2.php?action=<?php echo $do?>" method="post"  enctype="multipart/form-data" name="news" id="news"  onsubmit="javascript:return onsubmitform()" onreset="resetform()">
          <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="lightgrey_outline">
            ...
            <tr>
              ...
              <td colspan="3" valign="top" class="inputtextfiled_names"><input name="category" type="text" class="inputtextfiled" id="category" value="<?php echo $category?>" />
                &nbsp;&nbsp;&nbsp;</td>
            </tr>
            <tr>
              <td height="36"></td>
            ...
            <tr>
              <td height="36">Verification Code</td>
              <td>
...
?>
                <tr class="<?php echo $tablecss?>"onmouseover="this.bgColor='#B6DAF8'" onmouseout="this.bgColor='#FFFFFF'">
                  ...
                  <td width="73" align="center" valign="middle"><a href="category_add.php?cid=<?php echo $encoded_cid?>"><img src="images/Modify.png" width="20" height="20" border="0" title="Edit category" /></a></td>
...
if(md5($verif_box).'a4xn' == $_COOKIE['tntcon']){
	...
	header("Location: category_add2.php?category=$category"."&wrong_code=true");
	exit;
}
...
header("location:category_add2.php?mes=$message&$random");
