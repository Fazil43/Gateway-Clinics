...
?>
		    <tr class="<?php echo $tablecss?>">
		      ...
		      <td align="left" valign="top" class="table_slicer"><img src="<?php echo $root;?>/admin/<?php echo $image;?>" width="450" height="300" border="0" /></td>
		      	      <td width="106" align="center" valign="top" class="table_slicer"><a href="delete_gallery.php?nid=<?php echo $encoded_cid?>" onclick="return confirm('Are you sure you want to delete?')"  title="Delete">Delete</a></td>
	        </tr>
		    <?php }?>
	      </table>
