...
$decodedcategoryid=base64_decode($gettingitemid);
 ...
 $sel="SELECT  * FROM  $_table83 where id='$decodedcategoryid' ";
...
?>
		<form action="commoncategory_add.php?action=<?php echo $do?>" method="post"  enctype="multipart/form-data" name="news" id="news"  onsubmit="return inamodel_validate(this);" onreset="resetform()">
...
?>
		          <tr class="<?php echo $tablecss?>"onmouseover="this.bgColor='#B6DAF8'" onmouseout="this.bgColor='#FFFFFF'">
		            ...
		            <td width="73" align="center" valign="middle"><a href="commoncategory_add.php?cid=<?php echo $encoded_cid?>"><img src="images/Modify.png" width="20" height="20" border="0" title="Edit category" /></a></td>
...
$category=addslashes($category1);
 ...
 $insert="insert into $_table83 (category) values('$category')";
$step1result=mysql_query($insert,$link) or die(mysql_error());
$message=base64_encode('category_success');
header("location:commoncategory_add.php?mes=$message&$random");
...
$newsid=$_POST['updated_id'];
  ...
  $update="update $_table83 set category='$category' where  id='$newsid' ";
