...
<body>
	...
	<div id="content" class="shell">
		...
		<form action="update_doctorimage.php?action=<?php echo $do;?>"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
...
$your_image = new _image;
	...
	$your_image->newWidth = 300;
	$your_image->newHeight = 180;
...
$Upinsql="update $_table48 set image='$resized' where id='$newsid'";
