...
$root=$_SERVER['root']."/vijayas/template/"; // local
...
unlink("thumbs/".$del_img1->image."");
	...
	if($sql){
		...
		header('Location:list_product.php');//THIS WAS SAMPLE.PHP - YOU MIGHT WANT TO CHANGE IT BACK
...
$decodednewsid=base64_decode($gettingproductnameid);
 ...
 $sel="SELECT  * FROM  $_table48 where id='$decodednewsid' ";
...
$set_limit     = $page * $limit - ($limit);
 $sel="SELECT * FROM $_table48  ORDER BY id DESC LIMIT $set_limit, $limit  ";
		$result=mysql_query($sel,$link) or die (mysql_error());
...
?>
		    <tr class="<?php echo $tablecss?>">
		      ...
		      <td align="left" valign="top" class="table_slicer"><img src="<?php echo $root;?>/admin/<?php echo $image;?>" width="150" height="150" border="0" /></td>
		      <td width="96" align="center" valign="top"><a href="update_weddingphoto.php?nid=<?php echo $encoded_cid?>">Edit</a></td>
		      <td width="106" align="center" valign="top" class="table_slicer"><a href="delete_weddingphoto.php?nid=<?php echo $encoded_cid?>" onclick="return confirm('Are you sure you want to delete?')"  title="Delete">Delete</a></td>
	        </tr>
		    <?php }?>
	      </table>
