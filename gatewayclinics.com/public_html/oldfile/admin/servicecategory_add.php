...
?>
		<form action="servicecategory_add.php?action=<?php echo $do?>" method="post"  enctype="multipart/form-data" name="news" id="news"  onsubmit="return inamodel_validate(this);" onreset="resetform()">
...
header("location:servicecategory_add.php?mes=$message&$random");
