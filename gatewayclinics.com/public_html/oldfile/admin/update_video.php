...
<body>
	...
	<div id="content" class="shell">
		...
		<form action="update_video.php?action=<?php echo $do;?>"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
		    ...
		    <tr>
		      <td width="817" align="center"><table width="800" border="0" align="center">
		        ...
		        <tr>
		          ...
		          <td><textarea id="video" name="video" style="height: 170px; width: 500px;"><?php echo $video;?></textarea>
		          EXAMPLE
...
$Upinsql="update $_table45 set name='$name',video='$video' where id='$newsid'";
...
header("location:list_video.php?mes=$message&$random");
