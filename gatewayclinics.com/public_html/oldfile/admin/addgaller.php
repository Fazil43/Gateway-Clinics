...
$decodednewsid=base64_decode($gettingproductnameid);
 ...
 $sel="SELECT  * FROM  $_table504 where id='$decodednewsid' ";
...
<body>
	...
	<div id="content" class="shell">
	  ...
	  <div id="help-nav"></div>
		...
		<form action="addgallery.php?action=<?php echo $do;?>"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
		  <table width="1000" border="1" bordercolor="#000000" align="center" cellpadding="1" cellspacing="1">
		    <tr>
		      <td width="817" align="center"><table width="800" border="0" align="center">
		        ...
		        <tr>
		          <td width="129" valign="top" class="left">Upload Gallery (width-450px, height-300px)</td>
...
$createddate=date('Y-m-d');
	...
	$your_image->newWidth = 1200;
	$your_image->newHeight = 420;
 ...
 $insert="insert into $_table504 (username,image,createddate)values('$username','$resized','$serverdate')";
...
header("location:addgallery.php?mes=$message&$random");
