   ...
   if (window.File && window.FileReader && window.FileList && window.Blob)
	{
		...
		if(fsize>999999999999999999999999991048576) 
		{
...
<form action="index2.php" method="post" enctype="multipart/form-data" id="MyUploadForm">
<input  type="text" value="<?php echo $id67;?>">
...
if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
	...
	if($image_res){
		...
		if(normal_resize_image($image_res, $image_save_folder, $image_type, $max_image_size, $image_width, $image_height, $jpeg_quality))
		{
			...
			echo '<img src="uploads1/'.$thumb_prefix . $new_file_name.'" alt="Thumbnail">';
			echo '<br />';
			echo '<img src="uploads1/'. $new_file_name.'" alt="Resized Image">';
			echo '</div>';
		}
		$img_id=$_POST['img_id'];
		 $insert="insert into $_table5 (username,img_id,image_file,smallimage)values('$username','$img_id','$thumb_prefix. $new_file_name','$new_file_name')";
