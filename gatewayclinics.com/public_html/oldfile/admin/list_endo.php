...
$decodednewsid=base64_decode($gettingproductnameid);
 ...
 $sel="SELECT  * FROM  $_table98 where id='$decodednewsid' ";
...
$set_limit     = $page * $limit - ($limit);
 $sel="SELECT * FROM $_table98  ORDER BY id DESC LIMIT $set_limit, $limit  ";
		$result=mysql_query($sel,$link) or die (mysql_error());
...
?>
		    <tr class="<?php echo $tablecss?>">
		      ...
		      <td width="96" align="center" valign="top"><a href="addendoscopyatlas.php?nid=<?php echo $encoded_cid?>">Edit</a></td>
