...
<body>
	...
	<div id="content" class="shell">
	  ...
	  <div id="help-nav"></div>
		...
		<form action="addweddingphoto.php"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
...
if(md5($verif_box).'a4xn' == $_COOKIE['tntcon']){
	...
	header("Location: addweddingphoto.php?category=$category&$image=$image"."&wrong_code=true");
	exit;
}
...
header("location:addweddingphoto.php?mes=$message&$random");
