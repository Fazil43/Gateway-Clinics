...
<body>
	...
	<div id="content" class="shell">
		...
		<form action="update_mainpage.php?action=<?php echo $do;?>"method="post" enctype="multipart/form-data" name="example" id="example"  onsubmit="return Inamodel_validate(this);">
		  <table width="1000" border="1" align="center">
		    <tr>
		      <td align="center"><table width="700" border="0" align="center">
		        ...
		        <tr>
		          <td align="center" valign="top" class="inputtextfiled_names"><div align="left"><a href="update_mainsimage.php?nid=<?php echo $encoded_id?>" class="style2">Edit 
                  Image1</a></div></td>
		          <td align="center" valign="middle">:</td>
...
$Upinsql="update $_table54 set title='$title',details='$details' where id='$newsid'";
...
header("location:list_mainpage.php?srid=$encoded_id");
