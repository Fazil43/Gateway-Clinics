...
$root=$_SERVER['root']."/beta/tdblog"; // local
...
if(isset($_POST['delete'])){
	...
	if($sql){
		...
		header('Location:list_faq.php');//THIS WAS SAMPLE.PHP - YOU MIGHT WANT TO CHANGE IT BACK
...
$set_limit     = $page * $limit - ($limit);
 $sel="SELECT * FROM $_table41  ORDER BY id DESC LIMIT $set_limit, $limit  ";
		$result=mysql_query($sel,$link) or die (mysql_error());
...
?>
		    <tr class="<?php echo $tablecss?>">
		      ...
		      <td width="96" align="center" valign="top"><a href="adddetails.php?nid=<?php echo $encoded_cid?>">Edit</a></td>
		      <td width="106" align="center" valign="top" class="table_slicer"><a href="delete_faq.php?nid=<?php echo $encoded_cid?>" onclick="return confirm('Are you sure you want to delete?')"  title="Delete">Delete</a></td>
	        </tr>
		    <?php }?>
	      </table>
