...
<li><a class="se" href="services.php?cid=<?php echo $encoded_cid;?>"><?php echo $category1;?></a></li>
<?php
		}
		?>
</ul></div>
...
$sql="select * from $_table84 $cond order by id  ";
$rs=mysql_query($sql,$link);
$rscount=mysql_num_rows($rs);
if($rscount!=0)
{
...
<h4 class="ali4" style="padding-bottom:20px;"><?php echo $category_name;?></h4>
