...
<!-- end banner -->
    ...
    <link rel="stylesheet" media="screen" type="text/css" href="css2/layout.css" />
    <link rel="stylesheet" media="screen" type="text/css" href="css2/spacegallery.css" />
    <link rel="stylesheet" media="screen" type="text/css" href="css2/custom.css" />
...
<li><img src="<?php echo $root;?>/admin/<?php echo $image45;?>" alt="" title="" id="wows1_0"/></li>
<?php
}
}
?>
...
<div class="span9">    --><h4 class="ali4" style="padding-bottom:20px;">Medical Tourism</h4>
<div id="myGallery" class="spacegallery">
<ul class="navigationTabs nes">
<?php
$sql="select * from $_table62";
$rs=mysql_query($sql,$link);
$rscount=mysql_num_rows($rs);
if($rscount!=0)
{
...
<li><a href=""><img src="<?php echo $root;?>/admin/<?php echo $image;?>" alt="" /></a></li>
<?php
}
}
?>
