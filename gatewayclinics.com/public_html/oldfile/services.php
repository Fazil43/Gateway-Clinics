...
<li><a class="se" href="?cid=<?php echo $encoded_cid;?>"><?php echo $category1;?></a></li>
<?php
		}
		?>
</ul></div>
...
$sql="select * from $_table55 $cond order by id  ";
$rs=mysql_query($sql,$link);
$rscount=mysql_num_rows($rs);
if($rscount!=0)
{
...
$image=$_POST['image'];
$sql="select * from $_table23 where id='$categoryid'";
$rs=mysql_query($sql,$link);
