...
<div class="span9"><h4 class="ali4" style="padding-bottom:20px;">News and Events</h4>
<?php
...
{
	?>
<div class="alin"><a href="<?php echo $root;?>/news/<?php echo $image2;?>" target="_blank"><img src="<?php echo $root;?>/news/<?php echo $image;?>" class="img-polaroid lft-img-margin pull-left img-width-200"></a><img src="images/new3.gif"><h5><?php echo $title;?></h5></div>
