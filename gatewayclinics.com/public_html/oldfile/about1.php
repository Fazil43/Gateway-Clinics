...
<div class="button">
             ...
             <ul class="menu">
                ...
                <li><a href="about.html" class="active">About Us</a>
					...
					<li><a href="Slide-Atlas.html">Slide Atlas</a></li>
                ...
                <li><a href="#">Services</a>
                    ...
                    <li><a href="Hernia-Ipom.html">Hernia Ipom</a></li>
					<li><a href="Hysterectomy.html">Hysterectomy</a></li>
					<li><a href="Inguinal-Hernia.html">Ingunal Hernia</a></li>
                    <li><a href="Piles.html">Piles (Hemorrhoids)</a></li>
					<li><a href="Anal-Fistula.html">Anal Fistula</a></li>
					<li><a href="Endoscopy.html">Endoscopy</a></li>
                    <li><a href="Colonoscopy.html">Colonoscopy</a></li>
					<li><a href="ERCP.html">ERCP</a></li>
					<li><a href="Weight Loss.html">Weight Loss Surgery</a></li>
                    <li><a href="Sleeve-Gastrectomy.html">Sleeve Gastrectomy</a></li>
					<li><a href="Gastric-Bypass-Surgery.html">Gastric Bypass Surgery</a></li>
                    </ul>
                </li>
                <li><a href="">Gallery</a>
                    <ul class="submenu">
                ...
                <li><a href="#">Categories</a>
                 <ul class="submenu">
					...
					<li><a href="Social-Service.html">Social Services</a></li>
					<li><a href="about-management.html">About Management</a></li>
					<li><a href="Infrastructure.html">Infrastructure</a></li>
                    </ul>
                </li>
                <li><a href="medical.html">Medical Tourism</a></li>
...
<div class="span9"><h4 class="ali4" style="padding-bottom:20px;">About Gateway Clinics</h4>
<?php
$sql="select * from $_table63 order by id ";
