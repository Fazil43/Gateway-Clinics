...
?>
		<div id="footer">
      		...
      		if(!isAuthPage()){ ?>
	      		<p>&copy; 2009-<?php echo date('Y'); ?> <a href="http://inwayhosting.com/" target="_blank" >Inway</a>
	      		<?php echo '&ndash; '. i18n_r('VERSION') .' '. $site_version_no;  ?>
	      		</p> 
      		</div> <!-- end .footer-left -->
	      	<div class="gslogo" >
		      	<a href="http://inwayhosting.com/" target="_blank" ><img src="template/images/inway.png" alt="Inway" /></a>
		    </div>
	      	<div class="clear"></div>
	      	<?php
